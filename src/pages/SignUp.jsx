                        ...
                        <div className="p-5 space-y-5">
                            ...
                            <form className="flex flex-col gap-3">
                              <div className="w-full">
                                <input type="text" className="w-full bg-[var(--color-f5f5f7)] border-none rounded-lg border-transparent  focus:ring-[var(--color-febd69)]" placeholder="  نام و نام خانوادگی"/>
                              </div>
                              <div className="w-full">
                              ...
                              <div className="w-full">
                                <input type="tel" className="w-full text-right bg-[var(--color-f5f5f7)] border-none rounded-lg border-transparent  focus:ring-[var(--color-febd69)]" placeholder=" شماره تلفن"/>
                              </div>
                              <div className="w-full">  
